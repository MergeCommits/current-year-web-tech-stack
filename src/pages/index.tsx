    ...
    return (
        <>
            ...
            >
                ...
                >
                    {"Create "}
                    <span className={"text-purple-300"}>{"T3"}</span> {"App"}
                </h1>
                <p className={"text-2xl text-gray-700"}>{"This stack uses:"}</p>
                <div
                    className={
                        "mt-3 grid gap-3 pt-3 text-center md:grid-cols-3 lg:w-2/3"
                    }
                >
                    <TechnologyCard
                        name={"NextJS"}
                ...
                <div
                    className={
                        "flex w-full items-center justify-center pt-6 text-2xl text-blue-500"
                    }
                >
                    {hello.data ? (
...
const AuthShowcase: FC = () => {
    ...
    return (
        <div className={"flex flex-col items-center justify-center gap-2"}>
            ...
            <button
                className={
                    "rounded-md border border-black bg-violet-50 px-4 py-2 text-xl shadow-lg hover:bg-violet-100"
                }
...
const TechnologyCard = ({
    ...
    return (
        <section
            className={
                "flex flex-col justify-center rounded border-2 border-gray-500 p-6 shadow-xl duration-500 motion-safe:hover:scale-105"
            }
        >
